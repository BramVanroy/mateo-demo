...
def main():
    ...
    st.markdown(
        ...
        " duplicate the running MATEO instance to your own profile. That means that you can create a private"
        " duplication of the MATEO interface **just for you** and free of charge!\n"
