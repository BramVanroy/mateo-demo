...
*   **CPU Image:**
    ...
    docker build --build-arg REPO_BRANCH=v1.8.4 -t mateo-demo:cpu-main -f https://raw.githubusercontent.com/BramVanroy/mateo-demo/refs/heads/main/docker/Dockerfile .
    ```
